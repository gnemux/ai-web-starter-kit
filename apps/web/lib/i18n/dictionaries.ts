    ...
    catcare: {
      ...
      owner: {
        ...
        shareHandoff: {
          ...
          privateShare: "私密分享，仅供照看者查看和提交",
          expiresAt: "有效期至 {date}",
          viewAndSubmit: "可查看和提交",
          introduction: "主人分享的临时照护交接。先核对猫咪，再按每天的到访步骤执行。",
          catsLabel: "照护猫咪",
          datesLabel: "照护日期",
          visitsLabel: "到访安排",
          visitsValue: "{days} 天 · {visits} 次/天",
          quickNavLabel: "照护交接快捷入口",
          ownerNotesLink: "先看主人交代",
          visitsLink: "查看到访步骤",
          ownerNotesTitle: "主人交代",
          guideTitle: "查看方式",
          guideDescription:
            "这个页面只显示主人授权的信息，不代表系统确认照看者真实身份。先核对日期和猫咪，再按每天的到访步骤执行；当天和已到日期可以提交，未来日期暂不开放提交。",
          tasksEyebrow: "照护任务",
          tasksTitle: "按日期和到访时间逐步执行",
          taskCountSummary: "{required} 项必做，{optional} 项可选",
          beforeVisit: "到访前先确认",
          footer:
            "这个页面只显示主人授权的照护信息，不绑定具体照看者身份。提交后，主人会在结果页看到完成、备注和异常反馈。",
          required: "必做",
          optional: "可选",
          appliesTo: "适用范围：{owner}",
          allCats: "全部猫咪",
          ...
          categoryTreat: "零食",
          categoryWater: "饮水",
          statusNotStarted: "未到日期",
          statusAllSubmitted: "已全部提交",
          statusTodayOpen: "今天可提交",
          statusLateOpen: "可补提交",
          dayLabel: "第 {count} 天 · {date}",
          collapse: "收起",
          expand: "展开",
          lockedDay: "这一天还没到，可以先查看安排；到当天后再提交完成、备注或异常。",
          visitLabel: "第 {count} 次到访 · {time}",
          submitted: "已提交",
          submittedException: "已提交异常",
          submittedNote: "已提交备注",
          submittedCompleted: "已提交完成",
          daySummary: "{visits} 次到访 · {tasks} 项任务",
          asNeededFrequency: "按现场情况执行",
          weeklyFrequency: "每周 {count} 次",
          everyTwoDaysFrequency: "每 2 日 {count} 次",
          dailyFrequency: "每日 {count} 次",
          visitSummary: "完成{items}",
          visitSummaryMore: "完成{items}等 {count} 项",
          listSeparator: "、",
          catsFallback: "猫咪",
          ownerInstructionsFallback: "按主人交代",
          dateRangeSeparator: " 至 ",
          errorExpiredLabel: "已过期",
          errorExpiredTitle: "分享链接已过期",
          errorExpiredDescription: "请联系主人重新生成新的照护链接。",
          errorInvalidLabel: "不可用",
          errorInvalidTitle: "分享链接不可用",
          errorInvalidDescription: "链接无效或复制不完整。请让主人重新发送。",
          errorRevokedLabel: "已撤销",
          errorRevokedTitle: "分享链接已撤销",
          errorRevokedDescription: "主人已经撤销这个链接，照看者无法继续查看照护计划。",
          errorUnavailableLabel: "已关闭",
          errorUnavailableTitle: "照护计划暂不可用",
          errorUnavailableDescription: "这个计划当前不再开放给照看者查看。",
          errorProtection: "为保护主人和猫咪信息，无效链接不会展示照护内容。"
        },
        careSubmission: {
          ...
          photoStillProcessing: "照片仍在处理中，请稍候再提交。",
          partialPhotoUploadFailed: "照护结果已提交，但部分照片上传失败，请在下方重试",
          exceptionSubmitted: "异常已优先提交，请在安全方便时补充照片",
          photosUploaded: "照护结果已提交，{count} 张照片已安全上传",
          required: "必做",
          optional: "可选",
          photoRequired: "需照片",
          submittedFallback: "已提交给主人查看",
          privatePhotos: "私密照片：{count}/3 张",
          editFeedback: "修改状态或备注",
          lockedUntil: "这项任务到 {date} 当天才开放提交。",
          saveFeedback: "保存最新反馈",
          submitResult: "提交这项结果",
          processingPhotos: "正在处理照片…",
          uploading: "上传中…",
          retryPhotos: "补充上传所选照片",
          formTitle: "提交结果",
          completed: "已完成",
          completedWithNote: "完成并备注",
          exception: "有异常",
          exceptionRequired: "异常说明（必填）",
          noteRequired: "备注（必填，仍算已完成）",
          noteOptional: "备注（可选）",
          exceptionPlaceholder: "请写清异常情况和已采取的处理",
          notePlaceholder: "可补充位置、食量、精神状态或需要主人知道的事",
          cancel: "取消修改",
          pending: "提交中…",
          requiredPhotoTitle: "照护照片（主人要求）",
          optionalPhotoTitle: "照护照片（可选）",
          photoDescription:
            "最多 3 张，可选择单张不超过 15 MB 的手机原图；上传前会自动压缩，服务端会再次清除定位信息，仅主人登录后可查看。",
          choosePhotos: "选择照片（还可选 {count} 张）",
          maximumPhotos: "已达到 3 张上限。",
          ...
          unsafeCompression: "当前浏览器无法把照片安全压缩到上传范围，请换一张照片后重试。"
        },
        metrics: {
          cats: "猫咪档案",
          onboarding: "新手进度",
  ...
  en: {
    ...
    catcare: {
      ...
      owner: {
        ...
        shareHandoff: {
          headerTitle: "Care tasks",
          anonymousAccess: "Anonymous access",
          privateShare: "Private share for sitter viewing and submission only",
          expiresAt: "Expires {date}",
          viewAndSubmit: "View and submit",
          introduction: "A temporary care handoff shared by the owner. Confirm the cats first, then follow each visit step by step.",
          catsLabel: "Cats in care",
          datesLabel: "Care dates",
          visitsLabel: "Visit schedule",
          visitsValue: "{days} days · {visits} visits/day",
          quickNavLabel: "Care handoff shortcuts",
          ownerNotesLink: "Read owner notes first",
          visitsLink: "View visit steps",
          ownerNotesTitle: "Owner notes",
          guideTitle: "How to use this page",
          guideDescription:
            "This page only shows information authorized by the owner and does not verify the sitter's identity. Confirm the dates and cats, then follow each visit. Today and past dates accept submissions; future dates remain view-only.",
          tasksEyebrow: "Care tasks",
          tasksTitle: "Complete each date and visit in order",
          taskCountSummary: "{required} required · {optional} optional",
          beforeVisit: "Confirm before the visit",
          footer:
            "This page only shows care information authorized by the owner and is not tied to a verified sitter identity. Submitted completion, notes, and exceptions appear on the owner's results page.",
          required: "Required",
          optional: "Optional",
          appliesTo: "Applies to: {owner}",
          allCats: "All cats",
          categoryEnvironment: "Environment",
          categoryLitter: "Litter",
          categoryMeal: "Meals",
          categoryMedicine: "Medication",
          categoryObserve: "Observation",
          categoryOther: "Other",
          categoryPlay: "Play",
          categoryTreat: "Treats",
          categoryWater: "Water",
          statusNotStarted: "Future date",
          statusAllSubmitted: "All submitted",
          statusTodayOpen: "Open today",
          statusLateOpen: "Late submission open",
          dayLabel: "Day {count} · {date}",
          collapse: "Collapse",
          expand: "Expand",
          lockedDay: "This date has not arrived yet. You can review the plan now and submit completion, notes, or exceptions on that date.",
          visitLabel: "Visit {count} · {time}",
          submitted: "Submitted",
          submittedException: "Exception submitted",
          submittedNote: "Note submitted",
          submittedCompleted: "Completion submitted",
          daySummary: "{visits} visits · {tasks} tasks",
          asNeededFrequency: "Follow the situation on site",
          weeklyFrequency: "{count} times per week",
          everyTwoDaysFrequency: "{count} times every 2 days",
          dailyFrequency: "{count} times per day",
          visitSummary: "Complete {items}",
          visitSummaryMore: "Complete {items} and {count} tasks total",
          listSeparator: ", ",
          catsFallback: "Cats",
          ownerInstructionsFallback: "Follow the owner's instructions",
          dateRangeSeparator: " to ",
          errorExpiredLabel: "Expired",
          errorExpiredTitle: "This share link has expired",
          errorExpiredDescription: "Ask the owner to generate a new care link.",
          errorInvalidLabel: "Unavailable",
          errorInvalidTitle: "This share link is unavailable",
          errorInvalidDescription: "The link is invalid or incomplete. Ask the owner to send it again.",
          errorRevokedLabel: "Revoked",
          errorRevokedTitle: "This share link has been revoked",
          errorRevokedDescription: "The owner revoked this link, so the care plan is no longer available to the sitter.",
          errorUnavailableLabel: "Closed",
          errorUnavailableTitle: "This care plan is unavailable",
          errorUnavailableDescription: "The owner is no longer sharing this care plan.",
          errorProtection: "Invalid links never reveal care details, protecting the owner's and cats' information."
        },
        careSubmission: {
          ...
          photoStillProcessing: "The photo is still being processed. Wait a moment before submitting.",
          partialPhotoUploadFailed: "The care result was submitted, but some photos failed to upload. Retry them below.",
          exceptionSubmitted: "The exception was submitted first. Add photos when it is safe and convenient.",
          photosUploaded: "The care result was submitted with {count} securely uploaded photos.",
          required: "Required",
          optional: "Optional",
          photoRequired: "Photo required",
          submittedFallback: "Submitted for the owner to review",
          privatePhotos: "Private photos: {count}/3",
          editFeedback: "Edit status or note",
          lockedUntil: "This task opens for submission on {date}.",
          saveFeedback: "Save latest feedback",
          submitResult: "Submit this result",
          processingPhotos: "Processing photos…",
          uploading: "Uploading…",
          retryPhotos: "Upload the selected photos",
          formTitle: "Submit result",
          completed: "Completed",
          completedWithNote: "Completed with note",
          exception: "Exception",
          exceptionRequired: "Exception details (required)",
          noteRequired: "Note (required; task remains completed)",
          noteOptional: "Note (optional)",
          exceptionPlaceholder: "Describe the exception and any action already taken",
          notePlaceholder: "Add location, food intake, behavior, or anything the owner should know",
          cancel: "Cancel changes",
          pending: "Submitting…",
          requiredPhotoTitle: "Care photos (required by owner)",
          optionalPhotoTitle: "Care photos (optional)",
          photoDescription:
            "Add up to 3 original phone photos, each no larger than 15 MB. Photos are compressed before upload; the server removes location metadata again, and only the signed-in owner can view them.",
          choosePhotos: "Choose photos ({count} remaining)",
          maximumPhotos: "The 3-photo limit has been reached.",
          unsupportedPhoto: "Only JPG, PNG, or WebP photos are supported.",
          oversizedPhoto: "Each original phone photo must be no larger than {megabytes} MB.",
          unsupportedBrowser: "This browser cannot process phone photos. Update the browser and try again.",
          unreadablePhoto: "The photo could not be read. Choose a JPG, PNG, or WebP photo.",
          unsafeCompression: "This browser could not compress the photo to the safe upload size. Choose another photo and try again."
        },
        metrics: {
          cats: "Cat profiles",
