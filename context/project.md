...
- MVP3 delivery must expose enough version evidence for reviewers: Commit SHA, Package Version, Schema Version, Deployment URL, CI, migration records, and smoke-test result.
