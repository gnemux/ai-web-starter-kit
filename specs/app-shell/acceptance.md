...
- [x] 已登录账户菜单只包含当前真实存在的入口：工作台、个人资料、套餐、AI、退出登录。
- [x] 桌面端和移动端导航都可用。
- [x] 登录后左侧导航和移动端横向导航使用同一套一级主导航：工作台、个人资料、套餐、AI。
...
- [x] Account 个人资料页只展示当前邮箱、display name 表单和保存反馈，不显示会话、资料、事件状态卡片。
- [x] Account 相关功能作为工作区一级菜单入口展示：个人资料、套餐、AI。
