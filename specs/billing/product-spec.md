...
- Provide a minimal Free / Plus / Pro / credit-pack model that can be reused by MVP3.
...
- Do not build a full pricing page, live provider checkout flow, invoice center, refund flow, or payment-method management UI in this issue.
- Do expose a minimal reviewer surface so Free / Plus / Pro / AI credit-pack assumptions and recent records can be checked by a teammate.
...
| --- | --- | --- |
| Plan | Product package such as Free, Plus, or Pro. | Billing config |
...
| Credit | Product-facing AI allowance. Provider/model tokens are converted into Credit below the UI layer. | Billing credit ledger |
...
| --- | --- | --- |
| Free | New users and local demos | Base placeholder features plus a small AI Credit allowance |
| Plus monthly | Early paid usage | Everything in Free, one extra placeholder feature, and a larger AI Credit allowance |
| Pro monthly | Product validation and paid SaaS examples | Everything in Plus, one advanced placeholder feature, and a larger AI Credit allowance |
| AI credit pack | Add-on | One-time Credit grant that can be consumed by AI flows |
...
| --- | --- | --- |
| `packages/core/src/billing.ts` | Free / Plus / Pro / AI credit-pack config, entitlement helpers, lifecycle helpers, and ledger input builders | Free, Plus, Pro, and AI credit-pack defaults are present and provider-neutral |
...
| `/account/billing` | Product-like Plans surface for template users and reviewers | Free/Plus/Pro selection shows the current plan state, included placeholder access, tier inheritance, prices, and recent plan purchase records without implying live payment is complete |
| `/account/usage` | Product-like AI surface for template users and reviewers | Available Credit, plan-vs-credit-pack source split, credit-pack top-up entry, top-up records, and Credit consumption records are grouped under the AI entry |

MVP3 should not redefine these assets. MVP3 should consume them through product flows such as Free/Plus/Pro gating, sandbox checkout, AI generation, and analytics funnel verification.
