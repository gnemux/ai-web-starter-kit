...
- [x] Signed-out users opening `/reference-product` are redirected to login with `next=/reference-product`.
- [x] `/` presents CatCare as the product first screen, not a generic starter page.
- [x] `/login` presents CatCare login/signup context and defaults to `/reference-product`.
...
- [x] A generated routine-first 12-screen flow board exists at `specs/reference-product/prototypes/catcare-gne-278-flow-board-v2.png` as visual guidance.
- [x] A generated paid-user state board exists at `specs/reference-product/prototypes/catcare-gne-278-paid-user-states-v3.png` as visual guidance.
- [x] A generated bilingual v6 flow board exists at `specs/reference-product/prototypes/catcare-gne-278-flow-board-v6.png` as the current PRODUCT-00 prototype guidance.
