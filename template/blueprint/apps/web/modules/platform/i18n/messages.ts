...
export const platformMessages = {
  "en-US": {
    ...
    signIn: "Sign in", createAccount: "Create account", email: "Email", password: "Password", confirmPassword: "Confirm password", passwordHint: "Use at least 8 characters.",
  ...
  "zh-CN": {
    ...
    signIn: "登录", createAccount: "创建账户", email: "邮箱", password: "密码", confirmPassword: "确认密码", passwordHint: "至少使用 8 个字符。",
    ...
    billing: "计费", billingDescription: "建立在可信服务端计费事实上的产品配置界面。", paymentDisabled: "支付已关闭", paymentDisabledDescription: "可启用沙盒安全测试，或配置经过审核的外部支付服务。", paymentIncomplete: "支付配置不完整", paymentNotImplemented: "尚未实现外部支付适配器", paymentSandboxReady: "支付沙盒已就绪",
    usage: "用量", usageDescription: "用量和额度属于已登录用户及服务端账本事实。", aiDisabled: "智能能力已关闭", aiDisabledDescription: "可启用模拟模式安全测试，或配置经过审核的外部智能服务。", aiIncomplete: "智能能力配置不完整", aiNotImplemented: "尚未实现外部智能能力适配器", aiMockReady: "智能能力模拟模式已就绪",
